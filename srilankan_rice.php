...
<header>
        ...
        <div><center><h1>SRI LANKAN RICE</h1></center></div>
        ...
        <section id="services">
                ...
                // filter using categories which i want to use here
                    ...
                    $res = mysqli_query($link,"select * from food where item_cat1='Rice' AND item_cat2='srilankan' AND item_cat3='vege'");
                ...
                // filter using categories which i want to use here
                    ...
                    $res = mysqli_query($link,"select * from food where item_cat1='Rice' AND item_cat2='srilankan' AND item_cat3='nonvege'");
