...
<link rel="stylesheet" href="css/us_lg.css">
...
<header>
            <div class="container">
                ...
                <nav>
                    <ul>
                        ...
                        <li class="dropdown current"><a href="#" class="dropbtn">Pizza</a>
        ...
        <div><center><h1>SRI LANKAN PIZZA</h1></center></div>
        ...
        <section id="services">
                ...
                // filter using categories which i want to use here
                    ...
                    $res = mysqli_query($link,"select * from food where item_cat1='Pizza' AND item_cat2='srilankan' AND item_cat3='vege'");
                ...
                ?> 
                            ...
                            <div class="box back1">
                                ...
                                <p class="prize">RS:<?php echo $row["item_price"];?> up</p>
                ...
                // filter using categories which i want to use here
                    ...
                    $res = mysqli_query($link,"select * from food where item_cat1='Pizza' AND item_cat2='srilankan' AND item_cat3='nonvege'");
