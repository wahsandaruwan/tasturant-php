...
<header>
        ...
        <div><center><h1>ITALIAN PIZZA</h1></center></div>
        ...
        <section id="services">
                ...
                // filter using categories which i want to use here
                    ...
                    $res = mysqli_query($link,"select * from food where item_cat1='Pizza' AND item_cat2='italian' AND item_cat3='vege'");
                ...
                // filter using categories which i want to use here
                    ...
                    $res = mysqli_query($link,"select * from food where item_cat1='Pizza' AND item_cat2='italian' AND item_cat3='nonvege'");
